                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="txt_doc" class="form-control input-sm" type="date" placeholder="Date of the Event"/>
                                </div>
                                <div class="form-group">
                                    <label>Event Name:</label>
                                    <input name="txt_act" class="form-control input-sm" type="text" placeholder="Event Name"/>
                                </div>
                                <div class="form-group">
